...
const userfeedbackSlider = [
  ...
  [
    {
      id: 1,
      content: 'MailPoet makes managing a subscriber list and designing eye-catching emails so easy. It has an awesome intuitive user interface with drag-and-drop features that helps you send out professional-looking newsletters in minutes.',
      author: 'Katrin',
      thumbnailImage: 'http://loremflickr.com/640/480/city'
    },
    {
        id: 2,
        content: 'Easy to implement and use, MailPoet has got everything you need in a newsletter plugin – nice design, all the technical features, but also freedom to customize it yourself! Highly recom',
        author: 'Francis',
  ...
  [
    {
      id: 1,
      content: 'I’ve been using MailPoet for sending out my weekly newsletter since 2016. Their system is easy to use, the customising tools are unreal, and the editorial integration makes it all so much easier. I would definitely recommend.',
      author: 'Jez Ryan',
